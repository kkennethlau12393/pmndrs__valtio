...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From pnpm-lock.yaml, pnpm@11.3.0
corepack enable

# step 2: dependencies, from your lockfile. From pnpm-lock.yaml, pnpm@11.3.0
